...
const {createUser , loginUser, updateUserRole, deleteUser,verifyUser, addHisab, upDateHisab, upDateInwardOutward, removeOutward, updateQuantity, contactFormMessage} = require('../controllers/post')
